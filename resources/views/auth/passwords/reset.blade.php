...
<head>
  ...
  <title>Kisan Pakistan | Reset Password</title>
  ...
  <link href="{{ asset('backend/css/layouts/page-center.css') }}" type="text/css" rel="stylesheet" media="screen,projection">
...
<body class="cyan">
  ...
  <div  class="row">
    <div class="col s12 z-depth-4 card-panel">
      ...
      <form class="login-form" method="post" action="{{ url('/update/password') }}">
        @csrf
        <div class="row">
          <div class="input-field col s12 center">
            <img src="{{ asset('backend/images/login-logo.png') }}" alt="" class="circle responsive-img valign profile-image-login">
            <p class="center login-form-text">Kisan Pakistan</p>
          </div>
        </div>
        @if (session('status'))
        ...
        <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-action-lock-outline prefix"></i>
            <input name="confirmed" type="password"  required>
        ...
        <div class="row">
          <div class="input-field col s6 m6 l6">
            <p class="margin medium-small"><a href="{{ url('/') }}">Login Now!</a></p>
          </div>

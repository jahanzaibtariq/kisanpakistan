        ...
        <div class="row">
          <div class="col s12 m12 l12">
            <div class="card-panel">
              ...
              <div class="row">
                <form class="col s12" method="post" action="{{ url('/admin/add/weed') }}">
                  @csrf
                  <div class="row">
                    ...
                    <div class="input-field col s6">
                      <input  type="text" name="weed_name" maxlength="100">
                  ...
                  <div class="row">
                    <div class="input-field col s6">
                      ...
                      <textarea style="width: 500px;height: 150px;" name="weed_description" maxlength="998"></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="row">

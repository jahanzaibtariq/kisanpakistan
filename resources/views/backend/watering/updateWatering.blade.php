        ...
        <div class="row">
          <div class="col s12 m12 l12">
            <div class="card-panel">
              @foreach($sql as $sq)
              <div class="row">
                <form class="col s12" method="post" action="/admin/watering/update/{{ $sq->id }}">
                  @csrf
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="input-field col s6">
                      ...
                      <textarea style="width: 500px;height: 150px;" name="wateringMethods" maxlength="998">{{ $sq->wateringMethods }}</textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="row">

        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5> Add Land Preparation Detail</h5>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col s12 m12 l12">
            <div class="card-panel">
              <div class="row">
                <form class="col s12" method="post" action="{{ url('/admin/add/land/preparation') }}">
                  @csrf
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="input-field col s6">
                      ...
                      <textarea style="width: 500px;height: 150px;" name="landPreparation" maxlength="998"></textarea>
                    </div>    
                  </div>
                  <div class="row">
                    <div class="row">

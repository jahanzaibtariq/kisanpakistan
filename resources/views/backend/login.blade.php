    ...
    <div class="col s12 z-depth-4 card-panel">
      <form class="login-form" method="post" action="{{ url('/admin/login') }}">
        ...
        @if(Session::has('error_message'))
          <div class="row margin">
            <div class="alert alert-danger alert-dismissible fade show" role="alert"> 
              <b style="text-align: center;">{{ Session::get('error_message') }}</b>
            </div>
          </div>
        @endif
        @if(Session::has('update_password'))
          <div class="row margin">
            <div class="alert alert-danger alert-dismissible fade show" role="alert"> 
              <b style="text-align: center;">{{ Session::get('update_password') }}</b>
            </div>
          </div>
        @endif
      ...
      <div class="row">
          ...
          <div class="input-field col s6 m6 l6">
              <p class="margin right-align medium-small"><a href="{{ url('/forgot') }}">Forgot password ?</a></p>
          </div>          
        </div>
